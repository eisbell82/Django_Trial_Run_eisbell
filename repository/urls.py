...
urlpatterns = [
    ...
    path("datasets/<slug:slug>/dashboards/add/", views.upload_dashboard, name="add_dashboard"),
    path("datasets/<slug:slug>/dashboards/<int:pk>/delete/", views.delete_dashboard, name="delete_dashboard"),
